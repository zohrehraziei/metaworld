...
from multiworld.envs.mujoco.sawyer_xyz_ik.base import SawyerXYZIKEnv
...
class SawyerPickAndPlace6DOFIKEnv(SawyerXYZIKEnv):
    def __init__(
            self,
    ...
    def model_name(self):     
        ...
        return get_asset_full_path('sawyer_multitask_ik/sawyer_pick_and_place.xml')
