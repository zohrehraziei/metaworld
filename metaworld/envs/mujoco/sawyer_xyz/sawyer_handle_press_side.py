...
class SawyerHandlePressSideEnv(SawyerXYZEnv):
    ...
    @property
    def model_name(self):
        return get_asset_full_path('sawyer_xyz/sawyer_handle_press_sideways.xml', v1=True)
    ...
    def reset_model(self):
        ...
        # self.sim.model.body_pos[self.model.body_name2id('box')] = self._state_goal
        self._set_obj_xyz(0)
        self._state_goal = self.get_site_pos('goalPress')
        self.curr_path_length = 0
        self.maxDist = np.abs(self.get_body_com('box')[-1] - self._state_goal[-1])
